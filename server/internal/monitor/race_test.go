...
func TestSubscriptionConcurrentAccess(t *testing.T) {
	...
	m := New(state)
	m.AddSubscription("24sk102-us", []string{"bhs", "vin"}, true, true, "SK102", nil, nil, false, 0, "", false, nil)
	m.AddSubscription("24adv01-v3", nil, true, false, "ADV1", nil, nil, true, 2, "acc-eu", false, nil)
	...
	go func() {
		...
		for i := 0; ; i++ {
			...
			m.AddSubscription("24sk102-us", []string{"bhs"}, i%2 == 0, true, "SK102", nil, nil, true, 1, "acc-us", false, nil)
		}
	}()
...
func TestSnapshotIsDeepCopy(t *testing.T) {
	...
	m := New(state)
	m.AddSubscription("24adv01-v3", []string{"gra"}, true, false, "ADV1", nil, nil, false, 0, "", false, nil)
